...
const SESSIONS_COLLECTION = 'sessions3'

async function createSession3(token: string): Promise<Date> {
...
export default async function handler(
    ...
    const expiresAt = await createSession3(token)
