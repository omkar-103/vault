// pages/api/auth/login2.ts
import type { NextApiRequest, NextApiResponse } from 'next'
import bcrypt from 'bcryptjs'
import { getDb } from '../../../lib/db'
import { generateToken } from '../../../lib/session'

const COOKIE_NAME = 'vault2_token'
const SESSIONS_COLLECTION = 'sessions2'

async function createSession2(token: string): Promise<Date> {
...
export default async function handler(
    ...
    const expiresAt = await createSession2(token)
